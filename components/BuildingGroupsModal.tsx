...
const BuildingGroupsModal = memo<BuildingGroupsModalProps>(({ visible, onClose, clientName, buildings, onRefresh }) => {
  ...
  const handleAddGroup = async () => {
    ...
    try {
      ...
      setFormData({ group_name: '', description: '', building_ids: [] });
      await loadGroups();
      onRefresh?.();
    } catch (error) {
          ...
          <View style={{
            ...
            <View style={commonStyles.content}>
              <Text style={[typography.body, { color: colors.textSecondary, marginBottom: spacing.md }]}>
                Group buildings together for easier scheduling and management. For example, group nearby buildings that are cleaned together.
              </Text>
